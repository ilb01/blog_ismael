                    ...
                    <table class="w-full min-h-full bg-white dark:bg-gray-800 rounded-lg shadow-lg table-fixed">
                        <thead class="bg-gradient-to-r from-blue-900 to-blue-600 text-white">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-lg font-semibold border-b-2 border-gray-600 text-center">Name
                                </th>
                                <th class="px-6 py-4 text-lg font-semibold border-b-2 border-gray-600 text-center">Comment ID</th>
